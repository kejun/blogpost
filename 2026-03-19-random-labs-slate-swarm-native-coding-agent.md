...
> 💡 **架构图说明**：原博客包含 Slate 群体原生架构示意图，展示 Thread Weaving 如何编排多个并行工作线程。查看原图请访问：[randomlabs.ai/blog/slate](https://randomlabs.ai/blog/slate)
...
> 💡 **流程图说明**：原博客包含 Thread Weaving 工作流程图，展示编排器如何分发任务给并行工作线程并收集情景片段。查看原图请访问：[randomlabs.ai/blog/slate](https://randomlabs.ai/blog/slate)
