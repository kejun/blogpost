# Dive into Claude Code：一份来自学术界的"解剖报告"

**文档日期：** 2026 年 4 月 27 日  
**标签：** Claude Code, AI Agent Architecture, Source-level Analysis, VILA-Lab, Safety Design

---

## 一、背景：当学术界开始"逆向"Claude Code

### 1.1 项目简介

[VILA-Lab/Dive-into-Claude-Code](https://github.com/VILA-Lab/Dive-into-Claude-Code) 是佐治亚理工学院（Georgia Tech）VILA-Lab 团队发布的一项系统性研究，对 Claude Code（v2.1.88）进行了**源码级别的架构分析**。

```
研究规模：
┌─────────────────────────────────────────────────────────────┐
│  代码量：~1,900 TypeScript 文件，~512K 行代码              │
│  版本：Claude Code v2.1.88                                  │
│  产出：学术论文 + 架构文档 + 设计指南 + 社区资源汇总         │
...
![Claude Code 代码库组成](./images/2026-04-27/claude_code_1_6.png)
...
![5 层架构](./images/2026-04-27/architecture_layers.png)
...
| **绑定资源约束？** | ~200K token 上下文窗口。每次模型调用前运行 5 层压缩 | 计算预算、显式 scratchpad |
...
![5 阶段压缩管线](./images/2026-04-27/compaction_pipeline.png)
...
![5 阶段压缩管线](./images/2026-04-27/compaction_pipeline.png)
*图 2：5 阶段渐进式压缩管线 - 从最廉价到最昂贵*

![5 层架构](./images/2026-04-27/architecture_layers.png)
*图 3：Claude Code 5 层架构 - 从 Surface 到 Backend*
